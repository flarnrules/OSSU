...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):  # Try all possible shifts
            decryption_attempt = self.apply_shift(shift)
            words = decryption_attempt.split()
            ...
            if valid_word_count > max_valid_word_count:
                ...
                best_shift = shift
                best_decryption = decryption_attempt

        return (best_shift, best_decryption)

def decrypt_story():
    # Obtain the encrypted story string
    encrypted_story = get_story_string()
    
    # Create a CiphertextMessage object using the encrypted story string
...
# Call the function to get the decrypted story and shift value
decrypted_story, shift_value = decrypt_story()

# Now you can print or use the decrypted_story and shift_value as needed
print(f'Shift Value: {shift_value}')
print(f'Decrypted Story: {decrypted_story}')
